...
#define DEFPHONENUMBER  "\"+79853520273\",145" // оставить дл€ совместимости
...
#define SMSVAR_CLOCK            4       // —ћ— по расписанию
...
uint16_t CNT_GSM_OnAndRegister(void);  // включить модуль и зарегитс€ в сети

uint16_t CNT_GSM_TransmitSMSToOPSOS(unsigned char* smstext, unsigned char* phone); // отдадим —ћ— ќѕ—ќ—у и вернем ID смски 
